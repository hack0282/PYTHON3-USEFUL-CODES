#I will try to update this more efficient with good screen hence this is the basic start
...
button_eqaul=Button(root,text="=",padx=91,pady=20,command=button_equal)
...
button_eqaul.grid(row=5,column=1,columnspan=2)
